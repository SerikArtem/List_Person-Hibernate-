...
//--------------------- DELETE ---------------------//
    ...
    public String deletePerson(@ModelAttribute("positionByID") Position position) throws SQLException {
        try {
...
//--------------------- Additional methods ---------------------//
    ...
    public String showPeopleWithThisPosition(@PathVariable("idPosition") int idPosition, Model model) throws Exception {
        Position position = positionServiceImpl.getPositionById(idPosition);
        List<Person> listPersonFromPosition = position.getPeople();
