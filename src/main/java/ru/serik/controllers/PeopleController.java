...
//--------------------- CREATE ---------------------//
    ...
    public String savePerson(@ModelAttribute("person") Person person) {
        ...
        try {
            ...
            LOGGER.error("Error creating or saving a new people in the DB.", e);
        }
...
//--------------------- UPDATE ---------------------//
    ...
    public String updatePerson(@ModelAttribute("personUpdate") Person personUpdate) {
        ...
        try {
            ...
            personServiceImpl.updatePerson(personUpdate);
